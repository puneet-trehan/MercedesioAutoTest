...
public class BaseMercedesTest {
    ...
    public static void setUpBrowser(String browser) {
        if (browser.equalsIgnoreCase("Chrome")) {
            ...
            // Set the cookie behavior to accept only first-party cookies
            profile.setPreference("network.cookie.cookieBehavior", 1);

            // Set the lifetime policy to expire cookies at the end of the session
            ...
            // Set the content blocking intro count to 2
            profile.setPreference("browser.contentblocking.introCount", 2);

            // Set the profile options to the customized profile
